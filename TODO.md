...
- **Checkpoint Architecture**: Generalized Custom Checkpoints (`Checkpoint1Zone` -> `Checkpoint1`, `Checkpoint2Zone` -> `Checkpoint2`). Collected coins and defeated mobs stay persistent across checkpoint respawns.
...
- [x] **Persistent Run Progress on Death**: Collected coins, powerups, and defeated enemies persist across checkpoint respawns without resetting.
